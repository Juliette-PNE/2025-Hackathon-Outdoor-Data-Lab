...
* synthèse fréquentation : sentiers, écocompteurs, refuges, données mobiles, traces GPS volontaires
* synthèse biodiversité : espèces sensibles, habitats naturels, observations GeoNature
* zones réglementées : cœur de parc, réserves, refuges, zones humides
* alertes automatiques : surfréquentation, dérangements potentiels, périodes sensibles
...
* import des données externes : météo, événements, Strava, Inaturalist
* import des données internes : zone humide, cartographie des habitats delphine, 
